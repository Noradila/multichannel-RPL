...
\subsection{Effect of multi-channel on performance}
- MiCMAC, Chrysso - reduced PDR when the number of channels increases
- ours could use any number of channels
...
\begin{figure}
\centering
\includegraphics[width=0.45\textwidth]{experiments/single_channel-eps-converted-to.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.45\textwidth]{experiments/multi_channel-eps-converted-to.pdf}
