...
\begin{figure}
\centering
\subfigure[Mild Interference]{\label{fig:mild}\includegraphics[width=0.3\textwidth]{experiments/mild.eps}}                
\subfigure[Moderate Interference]{\label{fig:mod}\includegraphics[width=0.3\textwidth]{experiments/moderate.eps}}
\subfigure[Extreme Interference]{\label{fig:extreme}\includegraphics[width=0.3\textwidth]{experiments/extreme.eps}}
...
In the single channel, the node does not have enough time to recover from the interference and drops all packets. Figure \ref{fig:interference} shows that the rate of packet loss increases over time and when the interference is sufficient then packet reception will entirely stop. However, as the interference rate decreases (less interference), the single channel performance improves as it has more time to recover.
