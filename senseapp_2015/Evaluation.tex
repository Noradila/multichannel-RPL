...
Figure \ref{fig:multi_interference} shows multi channel results for scenario 1 and scenario 2. Scenario 1 shows a better result than scenario 2 because most extreme channels are detected during probing which as a result, reduces packets loss while in scenario 2, there were a mix of 4 extreme channels, 4 moderate channels, 4 mild channels and 4 no interference channel. In moderate interference case, some of the interfered channels are not detected during probing which the node would use the interfered channel to receive packets. This is also the case with mild interference.
